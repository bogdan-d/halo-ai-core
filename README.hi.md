...
**8 मुख्य सेवाएँ · 128gb एकीकृत मेमोरी · lemonade + llama.cpp + kokoro tts · शून्य क्लाउड · लेगो ब्लॉक**
...
| **गेटवे** | caddy 2.x — :80 पर डैशबोर्ड |
| **vpn** | wireguard — qr कोड स्कैन करें, अपने फोन से स्टैक एक्सेस करें |
| **डैशबोर्ड** | :5090 पर स्टैट्स सर्वर — gpu, रैम, सेवाएँ, बूट पर ऑटो-लोड |
...
│  (Vulkan)  │  (Vulkan)    │  (CPU)               │
├────────────┴─────────────┴───────────────────────┤
│  Claude Code  │  डैशबोर्ड (:5090)  │ WireGuard   │
├───────────────┴────────────────────┴─────────────┤
│              ROCm 7.12.0 (gfx1151)               │
├──────────────────────────────────────────────────┤
...
|-------|-------------|--------|
| **ssh mesh** | बहु-मशीन नेटवर्किंग (डिफ़ॉल्ट, कहीं भी काम करता है) | [गाइड →](docs/wiki/SSH-Mesh.md) |
