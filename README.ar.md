...
**13 خدمة أساسية · 128 جيجابايت ذاكرة موحدة · Lemonade + llama.cpp + Nexus · بدون سحابة · قطع ليغو**
...
| **الألعاب** | Minecraft + LinuxGSM — إدارة خوادم الألعاب |
| **المقابلات** | interviewer — جلسات تدريب مقابلات مدعومة بالذكاء الاصطناعي |
| **المعايير** | lemonade eval — قياس أداء تلقائي وتحليل الدقة |
| **شبكة VPN** | lemonade nexus — شبكة WireGuard بدون ثقة مع حوكمة تشفيرية |
| **البوابة** | caddy 2.x — لوحة تحكم + بروكسي خدمات على :80 |
| **VPN** | wireguard — امسح رمز QR، وصول لمكدسك من هاتفك |
| **لوحة التحكم** | لوحة تحكم glass — تحميل النماذج، إحصائيات مباشرة، إدارة الوكلاء |
| **مدير الحزم** | مدير الحزم — حالة الخدمات، تتبع الإصدارات، محفزات البناء على :3010 |
...
| **خوادم ألعاب** | Minecraft + LinuxGSM | نشط |
