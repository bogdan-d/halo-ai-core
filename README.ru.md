...
**8 базовых сервисов · 128гб унифицированной памяти · lemonade + llama.cpp + kokoro tts · без облака · как лего**
...
| **шлюз** | caddy 2.x — дашборд на :80 |
| **vpn** | wireguard — отсканируйте qr-код, получите доступ к стеку с телефона |
| **дашборд** | сервер статистики на :5090 — gpu, озу, сервисы, автозагрузка при старте |
...
│  (Vulkan)  │  (Vulkan)    │  (CPU)               │
├────────────┴─────────────┴───────────────────────┤
│  Claude Code  │  Дашборд (:5090)  │ WireGuard    │
├───────────────┴───────────────────┴──────────────┤
│              ROCm 7.12.0 (gfx1151)               │
├──────────────────────────────────────────────────┤
